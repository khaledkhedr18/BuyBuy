...
def config(key, default=None, cast=None):
    """Simple config function replacement"""
...
# Django REST Framework (Simplified)
REST_FRAMEWORK = {
...
# Cache Configuration (Disable Redis for now)
# CACHES = {
#     'default': {
...
# Session Configuration (Disable cache backend)
